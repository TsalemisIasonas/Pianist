...
class ArpeggiosPage extends StatefulWidget {
  const ArpeggiosPage({Key? key}) : super(key: key);

  @override
  State<ArpeggiosPage> createState() => _ArpeggiosPageState();
}

class _ArpeggiosPageState extends State<ArpeggiosPage> {
  ...
  Future<void> loadJsonData() async {
    String jsonString = await rootBundle.loadString('assets/data/arpeggios.json');
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text("A R P E G G I O S"),
        elevation: 1,
